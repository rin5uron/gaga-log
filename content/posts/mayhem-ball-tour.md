...
<div class="setlist-song"><span class="setlist-song-number">2.</span> [Bloody Mary](/posts/bloody-mary)（短縮版、オペラティック）</div>
<div class="setlist-song"><span class="setlist-song-number">3.</span> Abracadabra（アカペライントロ）</div>
<div class="setlist-song"><span class="setlist-song-number">4.</span> [Judas](/posts/judas)（Abracadabraの要素を含む）</div>
<div class="setlist-song"><span class="setlist-song-number">5.</span> [Aura](/posts/aura)（短縮版、2020年以来ライブ初披露）</div>
...
<div class="setlist-song"><span class="setlist-song-number">8.</span> [Poker Face](/posts/poker-face)（オペラティック・イントロとアウトロ）</div>
...
<div class="setlist-song"><span class="setlist-song-number">14.</span> [Alejandro](/posts/alejandro)（短縮版）</div>
<div class="setlist-song"><span class="setlist-song-number">15.</span> The Beast（ライブ初披露、ギター）</div>
<div class="setlist-song"><span class="setlist-song-number">16.</span> Killah（拡張イントロ/アウトロ）</div>
...
<div class="setlist-song"><span class="setlist-song-number">22.</span> Shadow of a Man（拡張イントロ）</div>
<div class="setlist-song"><span class="setlist-song-number">23.</span> Kill for Love（ライブ初披露、スタンドアロン）</div>
<div class="setlist-song"><span class="setlist-song-number">24.</span> Summerboy（短縮版、2007年以来ライブ初披露、ギター）</div>
...
<div class="setlist-act">
<div class="setlist-song"><span class="setlist-song-number">31.</span> Credits（録音）</div>
<div class="setlist-song"><span class="setlist-song-number">32.</span> How Bad Do U Want Me</div>
<div class="setlist-song"><span class="setlist-song-number">33.</span> ARTPOP（録音アウトロ）</div>
</div>
...
このアクト構成が、アルバム『Mayhem』のコンセプトを体現している。ガガが語った「演劇的で電撃的な体験」が、ここにある。

**観客との距離感を前提にした、演劇的・物語的な構成。**最初から最後までコントロールされたパフォーマンス設計が、このツアーの特徴の一つだ。
