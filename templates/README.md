...
- **そのページの該当アーティストと該当曲はリンクなし**（テキストのみ）
...
リンク、アーティスト名表記、セクションの文量など、詳細なルールは `docs/CONTENT-RULES.md` を参照してください。

主なポイント：
- **リンクのルール**: そのページの該当アーティストと該当曲はリンクなし
- **アーティスト名表記**: フロントマター・見出し・リンクは英語表記、本文中はカタカナ表記
- **コラボ曲**: 参加している全アーティストに個別にリンクを付ける
- **セクションの文量**: 各セクション2〜5段落程度が適切
